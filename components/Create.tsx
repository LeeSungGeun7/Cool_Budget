...
import { Check } from '@/public/icon/icon';
import { expense, profit } from '@/common/literal';

import debounce from 'lodash/debounce' 
import { useSession } from 'next-auth/react';
import moment from 'moment';
import { BudgetFormSend } from '@/app/(route)/temp/action';
...
className={`fixed flex justify-evenly items-center bottom-0 flex-col rounded-t-3xl w-screen h-[90%] z-[500] border-[1px] bg-slate-100 border-slate-100`}
    ...
    >
            <MdCancel className='text-[30px] absolute left-3 top-3 z-[2000]' type='button' onClick={()=>{setBottomUp(false)}}></MdCancel>
