...
function Header({session,avatar}:any) {
  ...
  useEffect(() => {
    ...
    const mergeSession = session || user;
  ...
  return (
    <div className={`text-[14px] flex justify-between items-center w-full h-[70px] border-b-[0.5px] border-slate-300 bg-white text-black`}>
      ...
      <div className='p-1 m-4 flex justify-start items-center h-full w-[50%]'>
        <div onClick={()=>{route.push('/')}} className='flex justify-center items-center text-white rounded-full w-[60px] h-[70%] bg-black'>
          GAGE
        </div>
